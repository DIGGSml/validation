...
<xsl:stylesheet version="3.0"
    ...
    <xsl:import href="http://diggsml.org/def/validation/modules/diggs-functions.xsl"/>
    ...
    <xsl:import href="http://diggsml.org/def/validation/modules/diggs-check.xsl"/>
    
    <!-- Import schema validation module -->
    <xsl:import href="http://diggsml.org/def/validation/modules/schema-check.xsl"/>
    
    <!-- Import codeSpace validation module -->
    <xsl:import href="http://diggsml.org/def/validation/modules/codeSpace-validation.xsl"/>
 
    <!-- Import schematron validation module 
    <xsl:import href="http://diggsml.org/def/validation/modules/schematron-validation.xsl"/>
    -->
