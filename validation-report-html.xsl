    ...
    <html>
      <head>
        ...
        <style>
          ...
          .container {
              max-width: 1400px; /* Increased from 1200px to 1400px (+200px) */
              margin: 0 auto;
          ...
          h1 {
              color: #2c3e50;
              text-align: center;
              margin-bottom: 15px; /* Reduced margin to decrease header height */
              padding-bottom: 10px; /* Reduced padding to decrease header height */
          ...
          .header-container {
              ...
              padding-bottom: 10px;
              margin-bottom: 20px;
              height: 60px; /* Reduced header height by approx 40% */
          }
          ...
          .header-logo {
              ...
              width: 150px; /* Logo width as specified */
          }
          ...
          .summary-banner.success {
              background-color: #d4efdf; /* Darker shade */
              border-left: 4px solid #2ecc71;
          }
          
          .summary-banner.info {
              background-color: #d4e6f1; /* Darker shade */
              border-left: 4px solid #3498db;
          }
          
          .summary-banner.warning {
              background-color: #fae5d3; /* Darker shade */
              border-left: 4px solid #f39c12;
          }
          
          .summary-banner.error {
              background-color: #f5b7b1; /* Darker shade */
              border-left: 4px solid #e74c3c;
          }
          ...
          .table-container {
              max-height: 350px; /* Height limit for the table - 70% of editor height (500px) */
              overflow-y: auto;
              margin-bottom: 20px;
          }
          ...
          /* XML Editor styles - Modified for CodeMirror */
          .editor-container {
              margin-top: 20px;
          ...
          .editor-body.open {
              max-height: 500px;
              overflow: visible; /* Changed to visible for CodeMirror */
              display: block;
          }
          ...
          /* Make sure CodeMirror is hidden initially with the editor */
          ...
          /* Custom highlighting for View Element links */
          .xpath-highlight { 
              <!-- background-color: #ffff99; -->          
          ...
          /* Added for better responsiveness of the editor */
          ...
          function initCodeMirror() {
            ...
            try {
              ...
              codeMirror = CodeMirror.fromTextArea(editor, {
                ...
                indentUnit: 2, // Indentation unit is 2 spaces
